...
<body class="animsition">
  ...
  <div class="card-body">
    <h5 class="card-title">Se realizó actividad</h5>
    <p class="card-text">Se entrego actividad para la materia de Español a tiempo.</p>
    <a href="#" class="btn btn-primary">Ir a actividad</a>
  </div>
