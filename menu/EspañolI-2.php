                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6>Clase 1</h6>  <span class=" "><a href="#"><i class="fa fa-comment" aria-hidden="true"></i></a></span>
                                                            <span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6>Clase 2</h6> <span class=" "><a href="#"><i class="fa fa-comment" aria-hidden="true"></i></a></span>
                                                            <span>
                                                                <a href="#">Linguistica</a>
                                                            </span>
                                                        </div>
                                               ...
                                               <td> <button type="button" class="btn btn-secondary fa fa-play-circle m-l-10 m-b-10" data-toggle="modal" data-target="#largeModal2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6>Clase 3</h6>  <span class=" "><a href="#"><i class="fa fa-comment" aria-hidden="true"></i></a></span>
                                                            <span>
                                                                <a href="#">Proyecto</a>
                                                            </span>
                                                        </div>
                                               ...
                                               <td> <button type="button" class="btn btn-secondary fa fa-play-circle m-l-10 m-b-10" data-toggle="modal" data-target="#largeModal2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6>Clase 4</h6>  <span class=" "><a href="#"><i class="fa fa-comment" aria-hidden="true"></i></a></span>
                                                            <span>
                                                                <a href="#">tarea</a>
                                                            </span>
                                                        </div>
